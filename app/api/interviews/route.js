...
// POST /api/interviews — generate questions via OpenAI and save interview
...
Keep questions professional and relevant to the job requirements. Return only the JSON array, no additional text.`;
