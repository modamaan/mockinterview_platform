  ...
  return (
    <div className="border border-gray-300 shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow duration-300 ease-in-out bg-white">
      ...
      <div className="flex justify-between items-center mt-4 gap-3">
        ...
        <Button onClick={onViewDetails} size="sm" variant="outline" className="flex-1 border-blue-500 text-blue-500 hover:bg-blue-50">
          View Details
        </Button>
      </div>
    </div>
...
In this updated version, I've made the following changes to improve readability and user interaction:
- Increased padding for better spacing.
- Adjusted font sizes and margins for better text hierarchy.
- Changed button styles for better visual feedback and consistency.
- Ensured the card has a white background for better contrast.